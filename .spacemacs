...
;    Updated: 2018/06/16 06:23:36 by mrodrigu         ###   ########.fr        ;
...
you should place your code here."
  ...
  ;;(setq-default tab-width 4)
	...
	(defun my-create-newline-and-allman-format (&rest _ignored)
		...
		(progn
			(newline-and-indent)
			(previous-line) (previous-line) (search-forward "{") (backward-char)
...
(custom-set-variables
 ...
 '(electric-quote-chars (quote (39 39 8220 8221)))
 '(evil-escape-mode t)
